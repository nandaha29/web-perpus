...
function ambilPeminjamanBuku($kon, $id_pinjam)
{
    $sql = "SELECT * FROM buku 
            INNER JOIN detail_pinjam 
            ON detail_pinjam.id_buku = buku.id_buku 
...
{
    $sql = "SELECT * FROM peminjaman WHERE id_anggota = $id_anggota 
            AND status = 'Dipinjam'";
    $res = mysqli_query($kon, $sql);

    $pinjam = mysqli_affected_rows($res);
